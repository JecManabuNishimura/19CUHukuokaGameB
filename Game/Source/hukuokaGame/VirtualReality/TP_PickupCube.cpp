...
ATP_PickupCube::ATP_PickupCube()
{
	...
	static ConstructorHelpers::FObjectFinder<UStaticMesh> SM_Pickup(TEXT("StaticMesh'/Game/VirtualRealityTemplate/Geometry/Meshes/1M_Cube.1M_Cube'"));
	static ConstructorHelpers::FObjectFinder<UMaterialInstanceConstant> MI_SmallCubes(TEXT("MaterialInstanceConstant'/Game/VirtualRealityTemplate/VirtualReality/Materials/MI_SmallCubes.MI_SmallCubes'"));
