...
// Based On <Epic VR Template Convert C++ Open Source Project>
// Disable unnecessary function and command

#include "ThrillerVR_MotionController.h"
...
// Sets default values
AThrillerVR_MotionController::AThrillerVR_MotionController()
{
	...
	// SomWorks :D // static ConstructorHelpers::FObjectFinder<UAnimBlueprint> AnimBP_HandAnimation(TEXT("AnimBlueprint'/Game/VirtualRealityTemplate/VirtualReality/Mannequin/Animations/AnimBP_SomRightHand.AnimBP_SomRightHand'"));
	...
	static ConstructorHelpers::FObjectFinder<UClass> AnimBP_HandAnimation(TEXT("Class'/Game/VirtualRealityTemplate/VirtualReality/Mannequin/Animations/AnimBP_SomRightHand.AnimBP_SomRightHand_C'"));

	static ConstructorHelpers::FObjectFinder<USkeletalMesh> SK_Hand(TEXT("SkeletalMesh'/Game/VirtualRealityTemplate/VirtualReality/Mannequin/Character/Mesh/MannequinHand_Right.MannequinHand_Right'"));
	...
	static ConstructorHelpers::FObjectFinder<UStaticMesh> SM_FatCylinder(TEXT("StaticMesh'/Game/VirtualRealityTemplate/VirtualReality/Meshes/SM_FatCylinder.SM_FatCylinder'"));
	static ConstructorHelpers::FObjectFinder<UStaticMesh> SM_BeaconDirection(TEXT("StaticMesh'/Game/VirtualRealityTemplate/VirtualReality/Meshes/BeaconDirection.BeaconDirection'"));
	static ConstructorHelpers::FObjectFinder<UStaticMesh> SM_Cube(TEXT("StaticMesh'/Game/VirtualRealityTemplate/VirtualReality/Meshes/1x1_cube.1x1_cube'"));
	static ConstructorHelpers::FObjectFinder<UStaticMesh> SM_Beam(TEXT("StaticMesh'/Game/VirtualRealityTemplate/VirtualReality/Meshes/BeamMesh.BeamMesh'"));
	static ConstructorHelpers::FObjectFinder<UMaterial> M_Beam(TEXT("Material'/Game/VirtualRealityTemplate/VirtualReality/Materials/M_SplineArcMat.M_SplineArcMat'"));
	static ConstructorHelpers::FObjectFinder<UMaterial> M_ArcEndPoint(TEXT("Material'/Game/VirtualRealityTemplate/VirtualReality/Materials/M_ArcEndpoint.M_ArcEndpoint'"));
	static ConstructorHelpers::FObjectFinder<UMaterialInstanceConstant> MI_TeleportCylinderPreview(TEXT("MaterialInstanceConstant'/Game/VirtualRealityTemplate/VirtualReality/Materials/MI_TeleportCylinderPreview.MI_TeleportCylinderPreview'"));
	static ConstructorHelpers::FObjectFinder<UMaterialInstanceConstant> MI_ChaperoneOutline(TEXT("MaterialInstanceConstant'/Game/VirtualRealityTemplate/VirtualReality/Materials/MI_ChaperoneOutline.MI_ChaperoneOutline'"));
	static ConstructorHelpers::FObjectFinder<UHapticFeedbackEffect_Base> HapticEffect(TEXT("HapticFeedbackEffect_Curve'/Game/VirtualRealityTemplate/VirtualRealityBP/Blueprints/MotionControllerHaptics.MotionControllerHaptics'"));
...
void AThrillerVR_MotionController::OnConstruction(const FTransform& Transform)
{
...
void AThrillerVR_MotionController::BeginPlay()
{
	Super::BeginPlay();
...
// Called every frame
void AThrillerVR_MotionController::Tick(float DeltaTime)
{
...
AActor* AThrillerVR_MotionController::GetActorNearHand() const
{
...
void AThrillerVR_MotionController::GrabActor()
{
	bWantsToGrip = true;
...
void AThrillerVR_MotionController::ReleaseActor()
{
	bWantsToGrip = false;
...
void AThrillerVR_MotionController::ActivateTeleporter()
{
...
void AThrillerVR_MotionController::DisableTeleporter()
{
	if (bIsTeleporterActive)
	{
		bIsTeleporterActive = false;
...
bool AThrillerVR_MotionController::TraceTeleportDestination(TArray<FVector>& TracePoints, FVector& NavMeshLocation, FVector& TraceLocation)
{
...
void AThrillerVR_MotionController::ClearArc()
{
...
void AThrillerVR_MotionController::UpdateArcSpline(bool FoundValidLocation, TArray<FVector> SplinePoints)
{
...
void AThrillerVR_MotionController::UpdateArcEndPoint(bool ValidLocationFound, FVector NewLocation)
{
...
void AThrillerVR_MotionController::GetTeleportDestination(FVector& MyLocation, FRotator& MyRotation)
{
...
void AThrillerVR_MotionController::SetupRoomScaleOutline()
{
...
void AThrillerVR_MotionController::UpdateRoomScaleOutline()
{
...
void AThrillerVR_MotionController::RumbleController(float Intensity)
{
...
void AThrillerVR_MotionController::OnComponentBeginOverlap(UPrimitiveComponent* OverlappedComp, AActor* OtherActor, UPrimitiveComponent* OtherComp, int32 OtherBodyIndex, bool bFromSweep, const FHitResult& SweepResult)
{
...
void AThrillerVR_MotionController::UpdateHandAnimation()
{
...
void AThrillerVR_MotionController::SetTeleportRotation(FRotator& NewTeleportRotation)
{
